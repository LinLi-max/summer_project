...
int output(double U[4][gx + 2][gy + 2], double dx, double dy, double gam);
int test(double U[4][gx + 2][gy + 2], double dx, double dy, double gam, int s, int e,int rank ,int size);
...
int main(int argc, char *argv[])
{
    ...
    double U[4][gx + 2][gy + 2], U_half[4][gx + 2][gy + 2], F_G[4][gx + 2][gy + 2];
    ...
    //test(U, dx, dy, gam, s, e, rank, size);
