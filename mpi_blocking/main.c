/**
 * \file main.c
 * \brief The main function of oblique shock reflection simulation(using blocking data communication).
 * \author Lin li
 * \version 2.0
 * \date 2021-07-20
 */
...
int main(int argc, char *argv[])
{
	...
	{
        solver_2d(U, U_half, F, G, temp, dx, dy, dt, gam, s, e, left, right, rank, size, MPI_COMM_WORLD);  //use a second order Lax-Wendroff two-step difference scheme
